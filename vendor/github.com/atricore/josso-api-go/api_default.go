...
type ApiCreateIdpSaml2Request struct {
	ctx context.Context
	ApiService *DefaultApiService
	storeIdPSaml2Req *StoreIdPSaml2Req
}

func (r ApiCreateIdpSaml2Request) StoreIdPSaml2Req(storeIdPSaml2Req StoreIdPSaml2Req) ApiCreateIdpSaml2Request {
	r.storeIdPSaml2Req = &storeIdPSaml2Req
	return r
}

func (r ApiCreateIdpSaml2Request) Execute() (*StoreIdPSaml2Res, *http.Response, error) {
	return r.ApiService.CreateIdpSaml2Execute(r)
}
...
*/
func (a *DefaultApiService) CreateIdpSaml2(ctx context.Context) ApiCreateIdpSaml2Request {
	return ApiCreateIdpSaml2Request{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DefaultApiService) CreateIdpSaml2Execute(r ApiCreateIdpSaml2Request) (*StoreIdPSaml2Res, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *StoreIdPSaml2Res
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.CreateIdpSaml2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iam-deploy/idp_saml2"
	...
	// body params
	localVarPostBody = r.storeIdPSaml2Req
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiCreateOidcIdpRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
	storeOidcIdpReq *StoreOidcIdpReq
}

func (r ApiCreateOidcIdpRequest) StoreOidcIdpReq(storeOidcIdpReq StoreOidcIdpReq) ApiCreateOidcIdpRequest {
	r.storeOidcIdpReq = &storeOidcIdpReq
	return r
}

func (r ApiCreateOidcIdpRequest) Execute() (*StoreOidcIdpRes, *http.Response, error) {
	return r.ApiService.CreateOidcIdpExecute(r)
}

/*
CreateOidcIdp Method for CreateOidcIdp

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCreateOidcIdpRequest
*/
func (a *DefaultApiService) CreateOidcIdp(ctx context.Context) ApiCreateOidcIdpRequest {
	return ApiCreateOidcIdpRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return StoreOidcIdpRes
func (a *DefaultApiService) CreateOidcIdpExecute(r ApiCreateOidcIdpRequest) (*StoreOidcIdpRes, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *StoreOidcIdpRes
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.CreateOidcIdp")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iam-deploy/idp_oidc"
	...
	// body params
	localVarPostBody = r.storeOidcIdpReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r ApiDeleteIdpSaml2Request) DeleteReq(deleteReq DeleteReq) ApiDeleteIdpSaml2Request {
	r.deleteReq = &deleteReq
	return r
}

func (r ApiDeleteIdpSaml2Request) Execute() (*DeleteRes, *http.Response, error) {
	return r.ApiService.DeleteIdpSaml2Execute(r)
}
...
*/
func (a *DefaultApiService) DeleteIdpSaml2(ctx context.Context) ApiDeleteIdpSaml2Request {
	return ApiDeleteIdpSaml2Request{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DefaultApiService) DeleteIdpSaml2Execute(r ApiDeleteIdpSaml2Request) (*DeleteRes, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.DeleteIdpSaml2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiDeleteOidcIdpRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
	deleteReq *DeleteReq
}

func (r ApiDeleteOidcIdpRequest) DeleteReq(deleteReq DeleteReq) ApiDeleteOidcIdpRequest {
	r.deleteReq = &deleteReq
	return r
}

func (r ApiDeleteOidcIdpRequest) Execute() (*DeleteRes, *http.Response, error) {
	return r.ApiService.DeleteOidcIdpExecute(r)
}

/*
DeleteOidcIdp Method for DeleteOidcIdp

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiDeleteOidcIdpRequest
*/
func (a *DefaultApiService) DeleteOidcIdp(ctx context.Context) ApiDeleteOidcIdpRequest {
	return ApiDeleteOidcIdpRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return DeleteRes
func (a *DefaultApiService) DeleteOidcIdpExecute(r ApiDeleteOidcIdpRequest) (*DeleteRes, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.DeleteOidcIdp")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetBundlesRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
	getBundlesReq *GetBundlesReq
}

func (r ApiGetBundlesRequest) GetBundlesReq(getBundlesReq GetBundlesReq) ApiGetBundlesRequest {
	r.getBundlesReq = &getBundlesReq
	return r
}

func (r ApiGetBundlesRequest) Execute() (*GetBundlesRes, *http.Response, error) {
...
*/
func (a *DefaultApiService) GetBundles(ctx context.Context) ApiGetBundlesRequest {
	return ApiGetBundlesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DefaultApiService) GetBundlesExecute(r ApiGetBundlesRequest) (*GetBundlesRes, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetBundlesRes
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetBundles")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iam-deploy/server/bundles"
	...
	// body params
	localVarPostBody = r.getBundlesReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiGetIdpSaml2Request struct {
	ctx context.Context
	ApiService *DefaultApiService
	getIdPSaml2Req *GetIdPSaml2Req
}

func (r ApiGetIdpSaml2Request) GetIdPSaml2Req(getIdPSaml2Req GetIdPSaml2Req) ApiGetIdpSaml2Request {
	r.getIdPSaml2Req = &getIdPSaml2Req
	return r
}

func (r ApiGetIdpSaml2Request) Execute() (*GetIdPSaml2Res, *http.Response, error) {
	return r.ApiService.GetIdpSaml2Execute(r)
}
...
*/
func (a *DefaultApiService) GetIdpSaml2(ctx context.Context) ApiGetIdpSaml2Request {
	return ApiGetIdpSaml2Request{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DefaultApiService) GetIdpSaml2Execute(r ApiGetIdpSaml2Request) (*GetIdPSaml2Res, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetIdPSaml2Res
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetIdpSaml2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.getIdPSaml2Req
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r ApiGetIdpSaml2sRequest) Execute() (*GetIdPSaml2sRes, *http.Response, error) {
	return r.ApiService.GetIdpSaml2sExecute(r)
}
...
*/
func (a *DefaultApiService) GetIdpSaml2s(ctx context.Context) ApiGetIdpSaml2sRequest {
	return ApiGetIdpSaml2sRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DefaultApiService) GetIdpSaml2sExecute(r ApiGetIdpSaml2sRequest) (*GetIdPSaml2sRes, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetIdPSaml2sRes
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetIdpSaml2s")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iam-deploy/idp_saml2s"
...
type ApiGetInfoRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
	getServerInfoReq *GetServerInfoReq
}

func (r ApiGetInfoRequest) GetServerInfoReq(getServerInfoReq GetServerInfoReq) ApiGetInfoRequest {
	r.getServerInfoReq = &getServerInfoReq
	return r
}

func (r ApiGetInfoRequest) Execute() (*GetServerInfoRes, *http.Response, error) {
...
func (a *DefaultApiService) GetInfoExecute(r ApiGetInfoRequest) (*GetServerInfoRes, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetServerInfoRes
	)
	...
	localVarPath := localBasePath + "/iam-deploy/server/info"
	...
	// body params
	localVarPostBody = r.getServerInfoReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiGetOidcIdpRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
	getOidcIdpReq *GetOidcIdpReq
}

func (r ApiGetOidcIdpRequest) GetOidcIdpReq(getOidcIdpReq GetOidcIdpReq) ApiGetOidcIdpRequest {
	r.getOidcIdpReq = &getOidcIdpReq
	return r
}

func (r ApiGetOidcIdpRequest) Execute() (*GetOidcIdpRes, *http.Response, error) {
	return r.ApiService.GetOidcIdpExecute(r)
}

/*
GetOidcIdp Method for GetOidcIdp

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetOidcIdpRequest
*/
func (a *DefaultApiService) GetOidcIdp(ctx context.Context) ApiGetOidcIdpRequest {
	return ApiGetOidcIdpRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return GetOidcIdpRes
func (a *DefaultApiService) GetOidcIdpExecute(r ApiGetOidcIdpRequest) (*GetOidcIdpRes, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetOidcIdpRes
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetOidcIdp")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.getOidcIdpReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiGetOidcIdpsRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
	getOidcIdpReq *GetOidcIdpReq
}

func (r ApiGetOidcIdpsRequest) GetOidcIdpReq(getOidcIdpReq GetOidcIdpReq) ApiGetOidcIdpsRequest {
	r.getOidcIdpReq = &getOidcIdpReq
	return r
}

func (r ApiGetOidcIdpsRequest) Execute() (*GetOidcIdpsRes, *http.Response, error) {
	return r.ApiService.GetOidcIdpsExecute(r)
}

/*
GetOidcIdps Method for GetOidcIdps

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetOidcIdpsRequest
*/
func (a *DefaultApiService) GetOidcIdps(ctx context.Context) ApiGetOidcIdpsRequest {
	return ApiGetOidcIdpsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return GetOidcIdpsRes
func (a *DefaultApiService) GetOidcIdpsExecute(r ApiGetOidcIdpsRequest) (*GetOidcIdpsRes, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetOidcIdpsRes
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetOidcIdps")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iam-deploy/idp_oidcs"
...
func (r ApiUpdateIdpSaml2Request) Execute() (*StoreIdPSaml2Res, *http.Response, error) {
	return r.ApiService.UpdateIdpSaml2Execute(r)
}
...
*/
func (a *DefaultApiService) UpdateIdpSaml2(ctx context.Context) ApiUpdateIdpSaml2Request {
	return ApiUpdateIdpSaml2Request{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return StoreIdPSaml2Res
func (a *DefaultApiService) UpdateIdpSaml2Execute(r ApiUpdateIdpSaml2Request) (*StoreIdPSaml2Res, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.UpdateIdpSaml2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdateOidcIdpRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
	storeOidcIdpReq *StoreOidcIdpReq
}

func (r ApiUpdateOidcIdpRequest) StoreOidcIdpReq(storeOidcIdpReq StoreOidcIdpReq) ApiUpdateOidcIdpRequest {
	r.storeOidcIdpReq = &storeOidcIdpReq
	return r
}

func (r ApiUpdateOidcIdpRequest) Execute() (*StoreOidcIdpRes, *http.Response, error) {
	return r.ApiService.UpdateOidcIdpExecute(r)
}

/*
UpdateOidcIdp Method for UpdateOidcIdp

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiUpdateOidcIdpRequest
*/
func (a *DefaultApiService) UpdateOidcIdp(ctx context.Context) ApiUpdateOidcIdpRequest {
	return ApiUpdateOidcIdpRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return StoreOidcIdpRes
func (a *DefaultApiService) UpdateOidcIdpExecute(r ApiUpdateOidcIdpRequest) (*StoreOidcIdpRes, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.UpdateOidcIdp")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
